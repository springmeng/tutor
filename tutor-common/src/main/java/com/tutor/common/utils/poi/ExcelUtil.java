package com.tutor.common.utils.poi;
...
import com.tutor.common.annotation.Excel.ColumnType;
import com.tutor.common.annotation.Excel.Type;
import com.tutor.common.annotation.Excels;
import com.tutor.common.config.RuoYiConfig;
import com.tutor.common.core.domain.AjaxResult;
import com.tutor.common.core.text.Convert;
import com.tutor.common.exception.UtilException;
import com.tutor.common.utils.DateUtils;
import com.tutor.common.utils.DictUtils;
import com.tutor.common.utils.StringUtils;
import com.tutor.common.utils.file.FileTypeUtils;
import com.tutor.common.utils.file.FileUtils;
import com.tutor.common.utils.file.ImageUtils;
import com.tutor.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
    ...
    public Cell addCell(Excel attr, Row row, T vo, Field field, int column)
    {
        ...
        try
        {
            ...
            // 根据Excel中设置情况决定是否导出,有些情况需要保持为空,希望管理员填写这一列.
            if (attr.isExport())
            {
                // 创建cell
