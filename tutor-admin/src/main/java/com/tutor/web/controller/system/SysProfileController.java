...
import com.tutor.common.utils.file.FileUploadUtils;
import com.tutor.common.utils.file.FileUtils;
import com.tutor.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult updateProfile(@RequestBody SysUser user)
    {
        ...
        {
            return error("修改管理员'" + loginUser.getUsername() + "'失败，手机号码已存在");
        }
        if (StringUtils.isNotEmpty(user.getEmail()) && !userService.checkEmailUnique(currentUser))
        {
            return error("修改管理员'" + loginUser.getUsername() + "'失败，邮箱账号已存在");
        }
